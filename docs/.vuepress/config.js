    ...
    plugins: [
        ...
        * */
        [
            ...
            {
                appId: 'DF4PzHlrK2Wd19aD7Tgrx7Z2-MdYXbMMI',
                appKey: 'MYbznsHQNn8HgF5pdddIYoEk',
                masterKey: 'xYcCKoZsAMQpj3bF1afXmKWB',
                //下面这些是可选的
        ...
        * */
        [
            ...
            {
                excludes: ['/','/register/','/next-mood/','/aurora-archive/','/archive/','/footer.html','/404.html','/about/','/mood/','/link/','/tag/','/photo/','/aurora-coze/','/aurora-music/'],
                noTitle: '暂时没有标题配置'
            }
        ],
        /*
    ...
    * */
    themeConfig: {
        ...
        * */
        ...
        //网站开始时间，请按照以下格式进行
        startRunTime: "11/1/2023 12:22:00",
